...
import '../model/item_filter/item_filter_model.dart';
import '../model/system_settings/system_settings_model.dart';

const String svgPath = 'assets/svg/';

class Constant {
  static String appName = AppSettings.applicationName;
...
//notification types
  static const String notificationTypeItemUpdate = "item-update";
  static const String notificationTypeItemEdit = "item-edit";
  ...
  static const String notificationTypeJobApplication = "job-application";
  static const String notificationTypeApplicationStatus = "application-status";
