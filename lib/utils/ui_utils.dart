...
import 'package:e_commerce_app/utils/extensions/lib/currency_formatter.dart';
...
import '../controller/appTheme_controller/app_theme_controller.dart' show AppThemeController;
import '../core/app_themes.dart';
import '../core/routes.dart';
import '../model/item/item_model.dart';
import '../widgets/blurred_dialog_box.dart';
...
class UiUtils {
  ...
  static SystemUiOverlayStyle getSystemUiOverlayStyle({
    ...
    final isDarkMode =
        Get.find<AppThemeController>().appTheme.value == AppTheme.dark;
  ...
  static void setDefaultLocationValue({
    ...
    //     Get.find<FetchHomeScreenController>().fetch(
    //       city: "Bhuj",
    //       radius: HiveUtils.getNearbyRadius(),
    //     );
    //     Get.find<FetchHomeAllItemsController>().fetch(
    //       city: "Bhuj",
    //       radius: HiveUtils.getNearbyRadius(),
    //     );
    //   });
